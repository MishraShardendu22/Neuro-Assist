...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground px-6 md:px-12 lg:px-24">
      <header className="w-full bg-gradient-to-r from-primary to-secondary py-16 md:py-20 text-center">
        <motion.div
          initial="hidden"
          animate="visible"
        ...
        >
          <motion.h1
            variants={fadeInUp}
            className="text-5xl md:text-6xl lg:text-7xl font-bold text-primary-foreground"
          >
            Welcome to Our Platform
          </motion.h1>
          <motion.p
            variants={fadeInUp}
            className="mt-6 text-2xl md:text-3xl text-primary-foreground max-w-4xl mx-auto"
          >
          ...
          >
            {[
              ...
              <motion.div
                key={index}
                variants={fadeInUp}
                className="p-8 border rounded-xl bg-card shadow-lg hover:shadow-xl transition-all flex items-center gap-4"
              >
      ...
      <section className="w-full max-w-7xl mx-auto mt-20 text-center pb-20">
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="text-4xl md:text-5xl font-semibold">Get Started Today</h2>
          <p className="mt-4 text-2xl text-muted-foreground max-w-4xl mx-auto">
      ...
      <section className="w-full max-w-7xl mx-auto mt-20 text-center pb-20">
        ...
        >
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-8 border rounded-xl bg-card shadow-lg hover:shadow-xl transition-all">
              <h3 className="text-2xl font-bold">Stroke Incidence</h3>
              <p className="text-xl mt-2">15 million cases/year</p>
              <p className="text-sm mt-1 text-muted-foreground">Global Estimate</p>
            </div>
            <div className="p-8 border rounded-xl bg-card shadow-lg hover:shadow-xl transition-all">
              <h3 className="text-2xl font-bold">Stroke Mortality</h3>
              <p className="text-xl mt-2">5 million deaths/year</p>
              <p className="text-sm mt-1 text-muted-foreground">Global Estimate</p>
            </div>
            <div className="p-8 border rounded-xl bg-card shadow-lg hover:shadow-xl transition-all">
              <h3 className="text-2xl font-bold">Stroke Disabilities</h3>
              <p className="text-xl mt-2">5 million permanently disabled</p>
              <p className="text-sm mt-1 text-muted-foreground">Global Estimate</p>
            </div>
            <div className="p-8 border rounded-xl bg-card shadow-lg hover:shadow-xl transition-all">
              <h3 className="text-2xl font-bold">Recurrent Stroke Rate</h3>
              <p className="text-xl mt-2">25% within 5 years</p>
              <p className="text-sm mt-1 text-muted-foreground">Global Estimate</p>
            </div>
          </div>
        </motion.div>
      ...
      {/* Detailed Stroke Analytics Section */}
      <section className="w-full max-w-7xl mx-auto mt-20 text-center pb-20">
        <motion.div
          initial="hidden"
          whileInView="visible"
          ...
          >
            {[
              ...
              <motion.div
                key={index}
                variants={fadeInUp}
                className="p-8 border rounded-xl bg-card shadow-lg hover:shadow-xl transition-all flex items-center justify-center"
              >
