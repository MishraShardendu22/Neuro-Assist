          ...
          <motion.section variants={sectionVariants}>
            ...
            <ul className="space-y-4">
              <motion.li className="flex items-center gap-4 text-xl" variants={listItemVariants}>
                ...
                <Badge className="bg-secondary text-secondary-foreground px-4 py-2 text-lg">10:00 AM - 12:00 PM</Badge>
              </motion.li>
              <motion.li className="flex items-center gap-4 text-xl" variants={listItemVariants}>
                <MoveRight className="h-6 w-6 text-secondary mt-1 flex-shrink-0" />
                <span className="flex-1">Evening:</span>
                <Badge className="bg-secondary text-secondary-foreground px-4 py-2 text-lg">4:00 PM - 6:00 PM</Badge>
              </motion.li>
          ...
          <motion.section variants={sectionVariants}>
            ...
            <ul className="space-y-4">
              <motion.li className="flex items-start gap-3 text-xl" variants={listItemVariants}>
                ...
                <span>Dial <Badge className="bg-destructive text-destructive-foreground px-4 py-2 text-lg">102</Badge> for hospital emergencies.</span>
              </motion.li>
              {[
